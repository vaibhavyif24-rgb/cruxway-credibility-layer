...
const investmentCriteria = [
  { t: 'Target Sectors', d: 'Essential B2B services in regulated, compliance-driven industries where reliability, deep client relationships, and high barriers to entry define long-term value.' },
  { t: 'All Stages', d: 'We invest across all stages of a company\'s lifecycle, from founder-led transitions to mature businesses seeking operational improvement and strategic growth.' },
  { t: 'Underserved Markets', d: 'We focus on overlooked and underserved segments of the lower middle market where institutional capital has historically been absent.' },
  { t: 'Ownership Transition', d: 'We partner with founders and families navigating succession, providing clean transitions that preserve the legacy they built.' },
  { t: 'Proven Persistency', d: 'We look for businesses with demonstrated customer retention, recurring revenue patterns, and deep-rooted trust built over years of consistent delivery.' },
  { t: 'Cultural Fit', d: 'Alignment of values between Cruxway and the existing management team is non-negotiable. We invest in people as much as businesses.' },
  { t: 'Established Customer Trust', d: 'Companies with long-standing client relationships and high switching costs form the foundation of our investment thesis.' },
];
    ...
    <div>
      ...
      <section className="relative hero-gradient-animated text-primary-foreground overflow-hidden">
        ...
        <div className="relative max-w-[1080px] mx-auto px-5 md:px-10 lg:px-16 pt-24 pb-6 md:pt-32 md:pb-10 lg:pt-36 lg:pb-12">
          ...
          <FadeIn delay={0.08}>
            <h1 className="font-serif text-[clamp(2rem,4.5vw,3.4rem)] text-primary-foreground max-w-[580px] leading-[1.12] tracking-[-0.025em]">
