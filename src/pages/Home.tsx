      ...
      <Section dark>
        <div className="max-w-[480px]">
          <FadeIn>
            ...
            <Link
              to={`/${region}/contact`}
              className="inline-block font-sans text-[9.5px] font-medium uppercase tracking-[0.16em] px-7 py-3 border border-primary-foreground/[0.08] text-primary-foreground/35 hover:border-primary-foreground/20 hover:text-primary-foreground/65 transition-all duration-300"
            >
              Contact
            </Link>
          </FadeIn>
