    ...
    <div>
      ...
      <section className="relative bg-prussian text-primary-foreground overflow-hidden">
        ...
        <div className="relative max-w-[1120px] mx-auto px-6 md:px-12 lg:px-20 pt-32 pb-20 md:pt-44 md:pb-28 lg:pt-48 lg:pb-36">
          ...
          <FadeIn delay={0.1}>
            <h1 className="font-serif text-[clamp(2rem,5vw,3.25rem)] text-primary-foreground max-w-[480px] leading-[1.1] tracking-[-0.03em]">
              Get in Touch
            </h1>
          </FadeIn>
          <FadeIn delay={0.2}><GoldRule className="mt-8 mb-8" /></FadeIn>
          <FadeIn delay={0.3}>
            <p className="font-sans text-[15px] text-primary-foreground/35 max-w-[460px] leading-[1.8]">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          <div>
            <FadeIn>
              ...
              <h2 className="font-serif text-[clamp(1.5rem,3vw,2.25rem)] text-foreground mb-2">
                Reach Our Team
              </h2>
              <GoldRule className="mt-4 mb-8" />
              <div className="border-t border-foreground/[0.05]">
                <div className="py-7">
                  <p className="font-sans text-[10px] font-medium uppercase tracking-[0.22em] text-muted-foreground/45 mb-2.5">Email</p>
                  <a
      ...
      <section className="bg-cream px-6 md:px-12 lg:px-20 py-12 md:py-16">
        <div className="max-w-[1120px] mx-auto">
          <FadeIn>
            <p className="font-sans text-[11px] text-muted-foreground/35 leading-[1.7] max-w-[640px]">
