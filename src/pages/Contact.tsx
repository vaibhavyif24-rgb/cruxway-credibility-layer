          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-5">
            <FadeIn>
              <motion.a href={`mailto:${email}`} className="block h-full" whileHover={{ y: -4 }} transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}>
                <GlassCard index={0} className="p-6 md:p-8 h-full">
                  ...
                  <p className="font-serif <p className="font-serif text-[1.15rem] md:text-[1.3rem] text-foreground group-hover:text-gold-dim transition-colors duration-500 tracking-[-0.01em]"> transition-colors duration-500 tracking-[-0.01em]">
                    {email}
                  </p>
            ...
            <FadeIn delay={0.08}>
              ...
              <GlassCard index={1} className="p-6 md:p-8 h-full">
                ...
                <p className="font-serif <p className="font-serif text-[1.15rem] md:text-[1.3rem] text-foreground tracking-[-0.01em]">">
                  {location}
                </p>
                <p className="font-sans text-[13px] md:text-[14px] text-muted-foreground leading-[1.7] mt-3">
                  {isIndia
