    ...
    >
      ...
      <div
        ...
        style={{
          background: isDark
            ...
            : 'radial-gradient(ellipse at center, hsl(43 78% 50% / 0.18), transparent 60%)',
        }}
      />
      ...
      <div className="relative flex flex-col items-center">
        ...
        <motion.h1
          ...
          style={{
            ...
            color: isDark ? 'hsl(43 78% 50% / 0.2)' : 'hsl(43 78% 50% / 0.22)',
          }}
        >
          Cruxway
          {/* Gold shimmer sweep */}
          <motion.span
            ...
            style={{
              background: isDark
                ...
                : 'linear-gradient(90deg, transparent 0%, hsl(43 78% 50% / 0.8) 50%, transparent 100%)',
      ...
      >
        <circle
          ...
          r="70"
          fill="none"
          stroke={isDark ? 'hsl(43 78% 50% / 0.12)' : 'hsl(43 78% 50% / 0.35)'}
          strokeWidth="0.5"
