...
const LIGHT_OVERLAY = 'linear-gradient(to bottom, rgba(248,245,240,0.8) 0%, rgba(248,245,240,0.9) 20%, rgba(248,245,240,0.95) 50%, rgba(248,245,240,0.97) 75%, rgba(248,245,240,0.99) 100%)';
        ...
        >
          ...
          <div className="relative" style={{ zIndex: 1 }}>
            <div className="text-center mb-8">
              <span className="font-sans font-semibold uppercase" style={{ color: 'hsl(43, 78%, 50%)', fontSize: '12px', letterSpacing: '0.28em' }}>Sectors We Look At</span>
              <div className="mx-auto mt-2.5 w-12 h-[1.5px]" style={{ background: 'hsl(43, 78%, 50%)' }} />
            </div>
    ...
    <section ref={containerRef} className="relative" style={{ height: '250vh' }}>
      <div className="sticky top-0 h-screen w-full overflow-hidden" style={{ backgroundColor: isDark ? '#0B131E' : 'hsl(var(--background))' }}>
        ...
        >
          ...
          <span style={{ color: 'hsl(43, 78%, 50%)' }}>permanent partner.</span>
        </h2>
        ...
        >
          <div className="text-center mb-10">
            <span
              ...
              style={{ color: 'hsl(43, 78%, 50%)', fontSize: '14px', letterSpacing: '0.28em' }}
            >
              Sectors We Look At
            </span>
            <div className="mx-auto mt-2.5 w-12 h-[1.5px]" style={{ background: 'hsl(43, 78%, 50%)' }} />
