      ...
      <div className="relative max-w-[1080px] mx-auto px-5 md:px-10 lg:px-16 py-10 md:py-12 lg:py-14 flex flex-col items-center text-center">
        {label && (
          ...
          >
            ...
            <p className="font-sans <p className="font-sans text-[11px] font-bold uppercase tracking-[0.25em] text-gold"> text-gold">
              {label}
            </p>
        ...
        {subtext && !stats && (
          <motion.p
            ...
            className={`font-sans className={`font-sans text-[14px] leading-[1.7] tracking-[0.01em] max-w-[520px] mt-7 md:mt-10 ${ tracking-[0.01em] max-w-[520px] mt-7 md:mt-10 ${
